...
class AppTheme {
  static const Color cBg = Color(0xFFFAF5FF);
  static const Color cSurface = Color(0xFFFFFFFF);
  static const Color cEdge = Color(0xFFE9D5FF);
  static const Color cAccent = Color(0xFF9333EA);
  static const Color cAccent2 = Color(0xFFC084FC);
  static const Color cInk = Color(0xFF3B0764);
